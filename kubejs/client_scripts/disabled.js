ItemEvents.tooltip(event => {
    ...
    event.add('extradisks:infinite_storage_disk', [Text.of('Disabled').red()])
    event.add('extradisks:infinite_storage_block', [Text.of('Disabled').red()])
    event.add('extradisks:infinite_storage_part', [Text.of('Disabled').red()])
    event.add('extradisks:infinite_fluid_storage_disk', [Text.of('Disabled').red()])
    event.add('extradisks:infinite_fluid_storage_block', [Text.of('Disabled').red()])
    event.add('extradisks:infinite_fluid_storage_part', [Text.of('Disabled').red()])
})